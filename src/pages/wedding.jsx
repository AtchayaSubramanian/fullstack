...
export default function Wedding(){
    ...
    return(
        ...
        <NavigationBar2/>
            ...
            {/* </div> */}
              <h1  style={{textAlign:'center',marginTop:'100px'}}>WEDDING PLANNING</h1>
         ...
         since we would have been there in advance assuring details are completed.  We are the liaison between you and the venue,
          catering, decorators in Indianapolis IN, entertainment, and photographers. 
            ...
            <div>
                ...
                <button  style={{textDecoration:'none',backgroundColor:' lightviolet', transition:' background-color 0.3s ease' ,
                marginTop:60,marginLeft:650,fontSize:40,marginBottom:40}}><Link to='/info'>CLICK HERE</Link></button>
            </div>  
            </div>
